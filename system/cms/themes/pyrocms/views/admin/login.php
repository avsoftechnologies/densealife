    ...
    <body id="login-body">
            ...
            <section id="content">
                <div id="content-body">
                    ...
                    <div class="form_inputs">
                        <ul>
                            <li>
                                <div class="input animated fadeIn" id="login-un"><input type="text" name="email" placeholder="<?php echo lang('global:email') ; ?>/Username"/></div>
                            </li>
        ...
        <footer id="login-footer">
            <div class="wrapper animated fadeIn" id="login-credits">
                Copyright &copy; 2010 - <?php echo date('Y') ; ?> <?php echo Settings::get('site_name') ; ?>
