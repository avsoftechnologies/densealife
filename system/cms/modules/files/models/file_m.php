...
class File_m extends MY_Model {
	...
	protected $table = 'files';
        ...
        const FILE_ACCESS_PROTECTED = 'protected';
	...
	public function get_tagged($tags)
	{
        ...
        public function update_access_level($file_id, $access = self::FILE_ACCESS_PUBLIC){
            return parent::update($file_id, array('access_level' => $access));
        }
}
