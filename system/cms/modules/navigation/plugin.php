    ...
    private function _build_links($links = array(), $return_arr = true)
    {
        ...
        foreach ($links as $link) {
            ...
            if (!in_array($current_class, $wrapper['class']) and
                    ...
                    $current_link and ( (is_array($wrapper['children']) and in_array_r($current_link, $wrapper['children'])) or ( is_string($wrapper['children']) and strpos($wrapper['children'], $current_link)))
            ) {
