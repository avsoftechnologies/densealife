...
class Admin extends Admin_Controller
{
    ...
    public function create()
    {
        ...
        if ( $this->form_validation->run() ) {
            if ( $id = $this->gallery_m->insertItems($this->input->post()) ) {
                // Everything went ok..
    ...
    public function manage($id)
    {
        ...
        if ( $this->form_validation->run() ) {
            ...
            if ( $this->gallery_m->updateGallery($id, $this->input->post()) === TRUE ) {
    ...
    public function ajax_update_order()
    {
        ...
        $i = 1 ;
        foreach ( $ids as $id ) {
            $this->gallery_image_m->updateGallery($id, array(
                'order' => $i
            )) ;
            ...
            if ( $i === 1 ) {
                ...
                if ( $preview ) {
                    ...
                    $this->db->updateGallery('galleries', array(
