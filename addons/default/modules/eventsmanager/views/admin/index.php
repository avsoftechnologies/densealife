...
<section class="title">
    <h4><?php echo lang('eventsmanager:management_label') ; ?></h4>
</section>
...
//        echo $this->load->view('admin/partials/filters') ;
        ...
        if ( count($events) > 0 ):
            ...
            <div class="blank-slate">
                <img src="<?php echo $module_path . '/img/event.png' ?>" />
                <h4><?php echo lang('eventsmanager:no_event_error') ; ?></h4>
            <?php echo anchor('admin/eventsmanager/create/', lang('eventsmanager:lets_start_label'), 'class="btn green add"') ; ?>
            </div>
<?php endif ; ?>
    </div>
</section>