    ...
    <div class="content">
        ...
        <div class="tabs">
            ...
            <ul class="tab-menu">
                ...
                <li><a class="tab" href="admin/eventsmanager/createalbum"><span>Album</span></a></li>
                <li><a class="tab" href="admin/eventsmanager/create-cover"><span>Cover Photo</span></a></li>
                <li><a class="tab" href="admin/eventsmanager/create-thumbnail"><span><?php echo lang('eventsmanager:thumbnail_label') ; ?></span></a></li>
                <?php endif; ?>
            </ul>
