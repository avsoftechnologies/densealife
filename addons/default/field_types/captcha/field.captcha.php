...
class Field_captcha {
    ...
    public function form_output($data) {
        ...
        $options['class'] = 'captchawidth namebg captch-bg-position';
...
//        return '<div id="captcha" class="btn-color captcha-image">' . $cap['image'] . '</div>' . form_input($options);
        return form_input($options).'<div style="padding-top:40px;">'.$cap['image'] .'</div>';
    }
